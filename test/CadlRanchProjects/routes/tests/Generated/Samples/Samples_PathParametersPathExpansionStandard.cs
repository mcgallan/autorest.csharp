...
{
    public partial class Samples_PathParametersPathExpansionStandard
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Standard_Primitive_ShortVersion()
        {
            PathParametersPathExpansionStandard client = new RoutesClient().GetPathParametersClient().GetPathParametersPathExpansionClient().GetPathParametersPathExpansionStandardClient();
