...
{
    public partial class Samples_QueryParametersQueryContinuationStandard
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public void Example_Standard_Primitive_ShortVersion()
        {
            QueryParametersQueryContinuationStandard client = new RoutesClient().GetQueryParametersClient().GetQueryParametersQueryContinuationClient().GetQueryParametersQueryContinuationStandardClient();
