...
namespace Routes
{
    ...
    public partial class PathParametersMatrixExpansionExplode
    {
        ...
        /// <include file="Docs/PathParametersMatrixExpansionExplode.xml" path="doc/members/member[@name='PrimitiveAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> PrimitiveAsync(string param, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PathParametersMatrixExpansionExplode.Primitive");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PathParametersMatrixExpansionExplode.xml" path="doc/members/member[@name='Primitive(string,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PathParametersMatrixExpansionExplode.xml" path="doc/members/member[@name='ArrayAsync(IEnumerable{string},RequestContext)']/*" />
        public virtual async Task<Response> ArrayAsync(IEnumerable<string> param, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("PathParametersMatrixExpansionExplode.Array");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PathParametersMatrixExpansionExplode.xml" path="doc/members/member[@name='Array(IEnumerable{string},RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PathParametersMatrixExpansionExplode.xml" path="doc/members/member[@name='RecordAsync(IDictionary{string,int},RequestContext)']/*" />
        public virtual async Task<Response> RecordAsync(IDictionary<string, int> param, RequestContext context = null)
        {
            Argument.AssertNotNull(param, nameof(param));

            using var scope = ClientDiagnostics.CreateScope("PathParametersMatrixExpansionExplode.Record");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/PathParametersMatrixExpansionExplode.xml" path="doc/members/member[@name='Record(IDictionary{string,int},RequestContext)']/*" />
