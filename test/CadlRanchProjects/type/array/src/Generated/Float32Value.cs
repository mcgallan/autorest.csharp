...
namespace _Type._Array
{
    ...
    public partial class Float32Value
    {
        ...
        /// <summary> Put. </summary>
        /// <param name="arrayfloat32"> The <see cref="IEnumerable{T}"/> where <c>T</c> is of type <see cref="float"/> to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="arrayfloat32"/> is null. </exception>
        /// <include file="Docs/Float32Value.xml" path="doc/members/member[@name='PutAsync(IEnumerable{float},CancellationToken)']/*" />
        public virtual async Task<Response> PutAsync(IEnumerable<float> arrayfloat32, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(arrayfloat32, nameof(arrayfloat32));

            using RequestContent content = RequestContentHelper.FromEnumerable(arrayfloat32);
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        public virtual Response Put(IEnumerable<float> arrayfloat32, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(arrayfloat32, nameof(arrayfloat32));
