...
namespace _Type._Array
{
    ...
    public partial class ArrayClient
    {
        ...
        {
            return Volatile.Read(ref _cachedReadOnlyStringValue) ?? Interlocked.CompareExchange(ref _cachedReadOnlyStringValue, new ReadOnlyStringValue(ClientDiagnostics, _pipeline, _endpoint), null) ?? _cachedReadOnlyStringValue;
        }

        /// <summary> Initializes a new instance of ReadOnlyIntValue. </summary>
        public virtual ReadOnlyIntValue GetReadOnlyIntValueClient()
        {
            return Volatile.Read(ref _cachedReadOnlyIntValue) ?? Interlocked.CompareExchange(ref _cachedReadOnlyIntValue, new ReadOnlyIntValue(ClientDiagnostics, _pipeline, _endpoint), null) ?? _cachedReadOnlyIntValue;
        }
        ...
        {
            return Volatile.Read(ref _cachedReadOnlyModelValue) ?? Interlocked.CompareExchange(ref _cachedReadOnlyModelValue, new ReadOnlyModelValue(ClientDiagnostics, _pipeline, _endpoint), null) ?? _cachedReadOnlyModelValue;
        }
