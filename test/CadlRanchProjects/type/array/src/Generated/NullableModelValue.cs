...
namespace _Type._Array
{
    ...
    public partial class NullableModelValue
    {
        ...
        /// <summary> Put. </summary>
        /// <param name="array"> The <see cref="IEnumerable{T}"/> where <c>T</c> is of type <see cref="InnerModel"/> to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public virtual async Task<Response> PutAsync(IEnumerable<InnerModel> array, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Response Put(IEnumerable<InnerModel> array, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(array, nameof(array));
