...
namespace _Type.Property.Optionality
{
    ...
    public partial class ReadOnlyModelList
    {
        ...
        internal ReadOnlyModelList(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint)
        {
        ...
        /// <include file="Docs/ReadOnlyModelList.xml" path="doc/members/member[@name='GetDefaultAsync(CancellationToken)']/*" />
        public virtual async Task<Response<ReadOnlyModelListProperty>> GetDefaultAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetDefaultAsync(context).ConfigureAwait(false);
            return Response.FromValue(ReadOnlyModelListProperty.FromResponse(response), response);
        }

        /// <summary> Get models that will return the default object. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/ReadOnlyModelList.xml" path="doc/members/member[@name='GetDefault(CancellationToken)']/*" />
        public virtual Response<ReadOnlyModelListProperty> GetDefault(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <include file="Docs/ReadOnlyModelList.xml" path="doc/members/member[@name='GetDefaultAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetDefaultAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("ReadOnlyModelList.GetDefault");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ReadOnlyModelList.xml" path="doc/members/member[@name='GetDefault(RequestContext)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/ReadOnlyModelList.xml" path="doc/members/member[@name='GetAllAsync(CancellationToken)']/*" />
        public virtual async Task<Response<ReadOnlyModelListProperty>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <summary> Get models that will return all properties in the model. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/ReadOnlyModelList.xml" path="doc/members/member[@name='GetAll(CancellationToken)']/*" />
        public virtual Response<ReadOnlyModelListProperty> GetAll(CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ReadOnlyModelList.xml" path="doc/members/member[@name='GetAllAsync(RequestContext)']/*" />
        public virtual async Task<Response> GetAllAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("ReadOnlyModelList.GetAll");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ReadOnlyModelList.xml" path="doc/members/member[@name='GetAll(RequestContext)']/*" />
