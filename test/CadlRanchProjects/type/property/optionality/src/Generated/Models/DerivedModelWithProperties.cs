...
namespace _Type.Property.Optionality.Models
{
    ...
    public partial class DerivedModelWithProperties
    {
        /// <summary>
        ...
        public DerivedModelWithProperties(IEnumerable<string> requiredList)
        {
        ...
        internal DerivedModelWithProperties(IList<string> requiredList, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public IList<string> RequiredList { get; }
    }
}
