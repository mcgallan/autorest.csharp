...
{
    public partial class ReadOnlyStringRecordProperty : IUtf8JsonSerializable, IJsonModel<ReadOnlyStringRecordProperty>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReadOnlyStringRecordProperty>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ReadOnlyStringRecordProperty FromResponse(Response response)
        {
