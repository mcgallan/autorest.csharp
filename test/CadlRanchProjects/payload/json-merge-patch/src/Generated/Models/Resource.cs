...
namespace Payload.JsonMergePatch.Models
{
    ...
    public partial class Resource
    {
        ...
        internal Resource(string name, string description, IDictionary<string, InnerModel> map, IList<InnerModel> array, int? intValue, float? floatValue, InnerModel innerModel, IList<int> intArray, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
