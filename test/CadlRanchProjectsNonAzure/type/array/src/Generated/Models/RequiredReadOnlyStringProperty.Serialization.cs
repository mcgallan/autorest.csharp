...
{
    public partial class RequiredReadOnlyStringProperty : IJsonModel<RequiredReadOnlyStringProperty>
    {
        ...
        internal static RequiredReadOnlyStringProperty FromResponse(PipelineResponse response)
        {
