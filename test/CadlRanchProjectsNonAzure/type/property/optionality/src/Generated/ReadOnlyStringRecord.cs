...
namespace Scm._Type.Property.Optionality
{
    ...
    public partial class ReadOnlyStringRecord
    {
        ...
        internal ReadOnlyStringRecord(ClientPipeline pipeline, Uri endpoint)
        {
            _pipeline = pipeline;
            _endpoint = endpoint;
        }
        ...
        public virtual async Task<ClientResult<ReadOnlyStringRecordProperty>> GetDefaultAsync()
        {
            ClientResult result = await GetDefaultAsync(null).ConfigureAwait(false);
            return ClientResult.FromValue(ReadOnlyStringRecordProperty.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }

        /// <summary> Get models that will return the default object. </summary>
        public virtual ClientResult<ReadOnlyStringRecordProperty> GetDefault()
        {
        ...
        public virtual async Task<ClientResult<ReadOnlyStringRecordProperty>> GetAllAsync()
        {
        ...
        /// <summary> Get models that will return all properties in the model. </summary>
        public virtual ClientResult<ReadOnlyStringRecordProperty> GetAll()
        {
