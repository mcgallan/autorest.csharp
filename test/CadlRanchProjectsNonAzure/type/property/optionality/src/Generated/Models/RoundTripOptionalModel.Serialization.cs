...
{
    public partial class RoundTripOptionalModel : IJsonModel<RoundTripOptionalModel>
    {
        ...
        internal static RoundTripOptionalModel FromResponse(PipelineResponse response)
        {
