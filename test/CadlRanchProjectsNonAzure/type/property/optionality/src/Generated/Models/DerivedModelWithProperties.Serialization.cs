...
{
    public partial class DerivedModelWithProperties : IJsonModel<DerivedModelWithProperties>
    {
        ...
        internal static DerivedModelWithProperties FromResponse(PipelineResponse response)
        {
