...
namespace Scm._Type.Property.Optionality.Models
{
    public partial class RoundTripModel : IJsonModel<RoundTripModel>
    {
        ...
        internal static RoundTripModel DeserializeRoundTripModel(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyDictionary<string, int> requiredIntRecord = default;
            ...
            IReadOnlyList<byte> requiredUint8Array = default;
            IReadOnlyList<byte> optionalUint8Array = default;
            BinaryData requiredUnknown = default;
            BinaryData optionalUnknown = default;
            IReadOnlyList<sbyte> requiredInt8Array = default;
            IReadOnlyList<sbyte> optionalInt8Array = default;
        ...
        internal static new RoundTripModel FromResponse(PipelineResponse response)
        {
