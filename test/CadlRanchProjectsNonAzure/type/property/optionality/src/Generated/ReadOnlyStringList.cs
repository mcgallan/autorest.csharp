...
namespace Scm._Type.Property.Optionality
{
    ...
    public partial class ReadOnlyStringList
    {
        ...
        internal ReadOnlyStringList(ClientPipeline pipeline, Uri endpoint)
        {
            _pipeline = pipeline;
            _endpoint = endpoint;
        }
        ...
        public virtual async Task<ClientResult<ReadOnlyStringListProperty>> GetDefaultAsync()
        {
            ClientResult result = await GetDefaultAsync(null).ConfigureAwait(false);
            return ClientResult.FromValue(ReadOnlyStringListProperty.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }

        /// <summary> Get models that will return the default object. </summary>
        public virtual ClientResult<ReadOnlyStringListProperty> GetDefault()
        {
        ...
        public virtual async Task<ClientResult<ReadOnlyStringListProperty>> GetAllAsync()
        {
        ...
        /// <summary> Get models that will return all properties in the model. </summary>
        public virtual ClientResult<ReadOnlyStringListProperty> GetAll()
        {
