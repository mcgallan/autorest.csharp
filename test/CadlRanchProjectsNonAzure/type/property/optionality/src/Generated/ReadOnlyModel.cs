...
namespace Scm._Type.Property.Optionality
{
    ...
    public partial class ReadOnlyModel
    {
        ...
        internal ReadOnlyModel(ClientPipeline pipeline, Uri endpoint)
        {
            _pipeline = pipeline;
            _endpoint = endpoint;
        }
        ...
        public virtual async Task<ClientResult<ReadOnlyModelProperty>> GetDefaultAsync()
        {
            ClientResult result = await GetDefaultAsync(null).ConfigureAwait(false);
            return ClientResult.FromValue(ReadOnlyModelProperty.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }

        /// <summary> Get models that will return the default object. </summary>
        public virtual ClientResult<ReadOnlyModelProperty> GetDefault()
        {
        ...
        public virtual async Task<ClientResult<ReadOnlyModelProperty>> GetAllAsync()
        {
        ...
        /// <summary> Get models that will return all properties in the model. </summary>
        public virtual ClientResult<ReadOnlyModelProperty> GetAll()
        {
