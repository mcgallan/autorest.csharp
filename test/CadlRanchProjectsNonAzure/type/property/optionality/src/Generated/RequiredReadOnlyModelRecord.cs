...
namespace Scm._Type.Property.Optionality
{
    ...
    public partial class RequiredReadOnlyModelRecord
    {
        ...
        internal RequiredReadOnlyModelRecord(ClientPipeline pipeline, Uri endpoint)
        {
            _pipeline = pipeline;
            _endpoint = endpoint;
        }
        ...
        public virtual async Task<ClientResult<RequiredReadOnlyModelRecordProperty>> GetDefaultAsync()
        {
            ClientResult result = await GetDefaultAsync(null).ConfigureAwait(false);
            return ClientResult.FromValue(RequiredReadOnlyModelRecordProperty.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }

        /// <summary> Get models that will return the default object. </summary>
        public virtual ClientResult<RequiredReadOnlyModelRecordProperty> GetDefault()
        {
        ...
        public virtual async Task<ClientResult<RequiredReadOnlyModelRecordProperty>> GetAllAsync()
        {
        ...
        /// <summary> Get models that will return all properties in the model. </summary>
        public virtual ClientResult<RequiredReadOnlyModelRecordProperty> GetAll()
        {
