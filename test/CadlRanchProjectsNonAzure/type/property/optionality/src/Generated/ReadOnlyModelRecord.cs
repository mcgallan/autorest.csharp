...
namespace Scm._Type.Property.Optionality
{
    ...
    public partial class ReadOnlyModelRecord
    {
        ...
        internal ReadOnlyModelRecord(ClientPipeline pipeline, Uri endpoint)
        {
            _pipeline = pipeline;
            _endpoint = endpoint;
        }
        ...
        public virtual async Task<ClientResult<ReadOnlyModelRecordProperty>> GetDefaultAsync()
        {
            ClientResult result = await GetDefaultAsync(null).ConfigureAwait(false);
            return ClientResult.FromValue(ReadOnlyModelRecordProperty.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }

        /// <summary> Get models that will return the default object. </summary>
        public virtual ClientResult<ReadOnlyModelRecordProperty> GetDefault()
        {
        ...
        public virtual async Task<ClientResult<ReadOnlyModelRecordProperty>> GetAllAsync()
        {
        ...
        /// <summary> Get models that will return all properties in the model. </summary>
        public virtual ClientResult<ReadOnlyModelRecordProperty> GetAll()
        {
