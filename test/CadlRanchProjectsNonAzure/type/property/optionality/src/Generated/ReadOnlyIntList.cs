...
namespace Scm._Type.Property.Optionality
{
    ...
    public partial class ReadOnlyIntList
    {
        ...
        internal ReadOnlyIntList(ClientPipeline pipeline, Uri endpoint)
        {
            _pipeline = pipeline;
            _endpoint = endpoint;
        }
        ...
        public virtual async Task<ClientResult<ReadOnlyIntListProperty>> GetDefaultAsync()
        {
            ClientResult result = await GetDefaultAsync(null).ConfigureAwait(false);
            return ClientResult.FromValue(ReadOnlyIntListProperty.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }

        /// <summary> Get models that will return the default object. </summary>
        public virtual ClientResult<ReadOnlyIntListProperty> GetDefault()
        {
        ...
        public virtual async Task<ClientResult<ReadOnlyIntListProperty>> GetAllAsync()
        {
        ...
        /// <summary> Get models that will return all properties in the model. </summary>
        public virtual ClientResult<ReadOnlyIntListProperty> GetAll()
        {
