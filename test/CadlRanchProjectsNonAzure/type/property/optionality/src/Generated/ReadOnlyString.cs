...
namespace Scm._Type.Property.Optionality
{
    ...
    public partial class ReadOnlyString
    {
        ...
        internal ReadOnlyString(ClientPipeline pipeline, Uri endpoint)
        {
            _pipeline = pipeline;
            _endpoint = endpoint;
        }
        ...
        public virtual async Task<ClientResult<ReadOnlyStringProperty>> GetDefaultAsync()
        {
            ClientResult result = await GetDefaultAsync(null).ConfigureAwait(false);
            return ClientResult.FromValue(ReadOnlyStringProperty.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }

        /// <summary> Get models that will return the default object. </summary>
        public virtual ClientResult<ReadOnlyStringProperty> GetDefault()
        {
        ...
        public virtual async Task<ClientResult<ReadOnlyStringProperty>> GetAllAsync()
        {
        ...
        /// <summary> Get models that will return all properties in the model. </summary>
        public virtual ClientResult<ReadOnlyStringProperty> GetAll()
        {
